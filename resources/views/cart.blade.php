                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            Detail</a>--}}
                            <a href="{{ route('cart.list') }}" class="nav-item nav-link active">Shopping Cart</a>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        {{--                <tr>--}}
                        {{--                    <td class="align-middle"><img src="{{asset('img/product-2.jpg')}}"
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <input class="form-control form-control-sm bg-secondary text-center" type="number"
                            ...
                            {{--                                    <input type="hidden" name="id" value="{{ $item->id}}"
                            >--}}
                            {{--                                    <input class="form-control form-control-sm bg-secondary text-center" type="number" name="quantity" value="{{ $item->quantity }}"--}}
            ...
            <div class="col-lg-4">
                <form class="mb-5" action="">
                    <div class="input-group">
                        <input readonly type="text" class="form-control p-4"
                            placeholder="Coupon Code Will be Used soon">
