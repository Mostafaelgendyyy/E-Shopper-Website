        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Free Shipping offers</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                {{--                    <p class="text-right">{{ $data->quantity}} Products</p>--}}
                <a href="{{ route('CategoryProducts',$data->id) }}"
                    class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="{{asset('img/category.jpg')}}" alt="">
                </a>
                <h5 class="font-weight-semi-bold m-0">{{$data->name}}</h5>
            </div>
        </div>
        @endforeach
