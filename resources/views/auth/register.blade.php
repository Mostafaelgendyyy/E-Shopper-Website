...
<div class="container-fluid vh-100 overflow-auto">
    <div class="row vh-100 ">
        <div class="col-lg-6 bg-gray p-5 text-center">
            ...
            <a href="{{ route('login') }}"><button class="btn fw-bold mb-5 btn-outline-success px-4 rounded-pill">log In</button></a>
                ...
                <div class="col-md-8 p-4 ikigui m-auto text-center align-items-center">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror ps-2 border-start-0 fs-7 inbg form-control-lg mb-0" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Name" aria-describedby="basic-addon1">
                            @error('name')
                        ...
                        <div class="input-group mb-4">
                            <span class="input-group-text border-end-0 inbg" id="basic-addon1"><i class="bi bi-lock"></i></span>
                            <input id="password-confirm" type="password" class="form-control ps-2 border-start-0 fs-7 inbg form-control-lg mb-0" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password" aria-describedby="basic-addon1">
                        </div>
